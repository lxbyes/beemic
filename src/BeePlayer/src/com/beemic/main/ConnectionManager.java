...
public class ConnectionManager {
	...
	private static ConnectJFrame connectFrame = null;
	
	private static DrawWavePanel playFrame = null;
			...
			while(!socket.isClosed()) {
				...
				try {
					...
					case Message.EXIT:
						...
						System.exit(0);
						break;
					case Message.PPT_PLAY:
						// 通过发送 Shift+F5键消息播放ppt
						robot.keyPress(KeyEvent.VK_SHIFT);
						robot.keyPress(KeyEvent.VK_F5);
						break;
					case Message.VK_LEFT:
						// 发送←消息
						robot.keyPress(KeyEvent.VK_LEFT);
						break;
					case Message.VK_RIGHT:
						// 发送→消息
